...
attribute shreg_extract : string;
    ...
    signal fid_in_val9_read_reg_293 : STD_LOGIC_VECTOR (0 downto 0);
    signal field_id_val8_read_reg_298 : STD_LOGIC_VECTOR (15 downto 0);
    signal cols_reg_303 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal icmp_ln979_reg_321 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal and_ln979_reg_334 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal colorFormat_val17_read_local : STD_LOGIC;
    signal fid_in_val9_read_local : STD_LOGIC;
    signal field_id_val8_read_local : STD_LOGIC;
    signal width_val7_read_local : STD_LOGIC;
    signal height_val4_read_local : STD_LOGIC;
    ...
    component design_1_v_tpg_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171 : component design_1_v_tpg_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        colorFormat_val17_load => colorFormat_val17_read_reg_288,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                colorFormat_val17_read_reg_288 <= colorFormat_val17_dout;
    ...
    and_ln979_fu_251_p2 <= (sof_reg_159 and icmp_ln979_reg_321);
    ...
    colorFormat_val17_read <= colorFormat_val17_read_local;

    colorFormat_val17_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            colorFormat_val17_read_local <= ap_const_logic_1;
        else 
            colorFormat_val17_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    fid_in_val9_read <= fid_in_val9_read_local;

    fid_in_val9_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            fid_in_val9_read_local <= ap_const_logic_1;
        else 
            fid_in_val9_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    field_id_val8_read <= field_id_val8_read_local;

    field_id_val8_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            field_id_val8_read_local <= ap_const_logic_1;
        else 
            field_id_val8_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    height_val4_read <= height_val4_read_local;

    height_val4_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            height_val4_read_local <= ap_const_logic_1;
        else 
            height_val4_read_local <= ap_const_logic_0;
        end if; 
    end process;

    i_2_fu_245_p2 <= std_logic_vector(unsigned(i_fu_100) + unsigned(ap_const_lv12_1));
    icmp_ln979_1_fu_240_p2 <= "1" when (i_fu_100 = rows_reg_308) else "0";
    ...
    width_val7_read <= width_val7_read_local;

    width_val7_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            width_val7_read_local <= ap_const_logic_1;
        else 
            width_val7_read_local <= ap_const_logic_0;
        end if; 
    end process;
