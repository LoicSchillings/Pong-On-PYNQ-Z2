...
--               c:/ProjectenVivado/Academiejaar_25-26/EOS-Project/EOS-Project.gen/sources_1/bd/design_1/ip/design_1_rgb2dvi_0_0/design_1_rgb2dvi_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2dvi_0_0_SyncAsync_6 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_rgb2dvi_0_0_SyncAsync_6 : entity is "SyncAsync";
end design_1_rgb2dvi_0_0_SyncAsync_6;

architecture STRUCTURE of design_1_rgb2dvi_0_0_SyncAsync_6 is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_rgb2dvi_0_0_SyncAsync__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_rgb2dvi_0_0_SyncAsync__parameterized1\ : entity is "SyncAsync";
end \design_1_rgb2dvi_0_0_SyncAsync__parameterized1\;

architecture STRUCTURE of \design_1_rgb2dvi_0_0_SyncAsync__parameterized1\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2dvi_0_0_ResetBridge_5 is
  port (
    AR : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_rgb2dvi_0_0_ResetBridge_5 : entity is "ResetBridge";
end design_1_rgb2dvi_0_0_ResetBridge_5;

architecture STRUCTURE of design_1_rgb2dvi_0_0_ResetBridge_5 is
  signal aRst_int : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int : signal is "true";
begin
  aRst_int <= aRst;
SyncAsyncx: entity work.design_1_rgb2dvi_0_0_SyncAsync_6
     port map (
      AR(0) => AR(0),
      AS(0) => aRst_int,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2dvi_0_0_ClockGen is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_rgb2dvi_0_0_ClockGen : entity is "ClockGen";
end design_1_rgb2dvi_0_0_ClockGen;

architecture STRUCTURE of design_1_rgb2dvi_0_0_ClockGen is
...
LockLostReset: entity work.design_1_rgb2dvi_0_0_ResetBridge_5
     port map (
      AR(0) => pRst,
      aRst => aRst,
      \oSyncStages_reg[0]\ => \oSyncStages_reg[0]\
    );
PLL_LockSyncAsync: entity work.\design_1_rgb2dvi_0_0_SyncAsync__parameterized1\
     port map (
      D(0) => oOut,
      \oSyncStages_reg[0]_0\ => \oSyncStages_reg[0]\,
...
entity design_1_rgb2dvi_0_0_rgb2dvi is
  ...
  attribute kClkRange of design_1_rgb2dvi_0_0_rgb2dvi : entity is 3;
  ...
  attribute kGenerateSerialClk of design_1_rgb2dvi_0_0_rgb2dvi : entity is "TRUE";
...
begin
\ClockGenInternal.ClockGenX\: entity work.design_1_rgb2dvi_0_0_ClockGen
     port map (
      PixelClk => PixelClkIO,
...
entity design_1_rgb2dvi_0_0 is
  ...
  attribute x_core_info of design_1_rgb2dvi_0_0 : entity is "rgb2dvi,Vivado 2024.1";
