...
reg   [7:0] colorFormat_val17_read_reg_288;
reg    ap_block_state1;
reg   [0:0] fid_in_val9_read_reg_293;
reg   [15:0] field_id_val8_read_reg_298;
reg   [12:0] cols_reg_303;
reg   [11:0] rows_reg_308;
wire   [12:0] sub_i_fu_211_p2;
reg   [12:0] sub_i_reg_316;
...
reg   [11:0] i_fu_100;
reg    colorFormat_val17_read_local;
reg    fid_in_val9_read_local;
reg    field_id_val8_read_local;
reg    width_val7_read_local;
reg    height_val4_read_local;
reg   [0:0] fid_preg;
reg   [3:0] ap_NS_fsm;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        colorFormat_val17_read_local = 1'b1;
    end else begin
        colorFormat_val17_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        fid_in_val9_read_local = 1'b1;
    end else begin
        fid_in_val9_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        field_id_val8_read_local = 1'b1;
    end else begin
        field_id_val8_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        height_val4_read_local = 1'b1;
    end else begin
        height_val4_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        width_val7_read_local = 1'b1;
    end else begin
        width_val7_read_local = 1'b0;
    end
end
...
assign and_ln979_fu_251_p2 = (sof_reg_159 & icmp_ln979_reg_321);
...
assign colorFormat_val17_read = colorFormat_val17_read_local;

assign fid_in_val9_read = fid_in_val9_read_local;

assign field_id_val8_read = field_id_val8_read_local;
...
assign height_val4_read = height_val4_read_local;

assign i_2_fu_245_p2 = (i_fu_100 + 12'd1);

assign icmp_ln979_1_fu_240_p2 = ((i_fu_100 == rows_reg_308) ? 1'b1 : 1'b0);
...
assign width_val7_read = width_val7_read_local;
