...
wire   [7:0] conv2_i_i_i129_fu_284_p3;
reg   [7:0] conv2_i_i_i129_reg_500;
...
reg    boxColorB_val_read_local;
reg    boxColorG_val_read_local;
reg    boxColorR_val_read_local;
reg    boxSize_val_read_local;
reg    crossHairY_val_read_local;
reg    crossHairX_val_read_local;
reg    colorFormat_val_read_local;
reg    colorFormat_val17_c_write_local;
reg    motionSpeed_val_read_local;
reg    maskId_val_read_local;
reg    patternId_val_read_local;
reg    width_val_read_local;
wire   [12:0] empty_fu_262_p1;
reg    width_val7_c_write_local;
reg    height_val_read_local;
wire   [11:0] empty_88_fu_267_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        ...
        conv2_i_i_i129_reg_500[6 : 4] <= conv2_i_i_i129_fu_284_p3[6 : 4];
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorB_val_read_local = 1'b1;
    end else begin
        boxColorB_val_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorG_val_read_local = 1'b1;
    end else begin
        boxColorG_val_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorR_val_read_local = 1'b1;
    end else begin
        boxColorR_val_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxSize_val_read_local = 1'b1;
    end else begin
        boxSize_val_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        colorFormat_val17_c_write_local = 1'b1;
    end else begin
        colorFormat_val17_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        crossHairX_val_read_local = 1'b1;
    end else begin
        crossHairX_val_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        crossHairY_val_read_local = 1'b1;
    end else begin
        crossHairY_val_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        maskId_val_read_local = 1'b1;
    end else begin
        maskId_val_read_local = 1'b0;
    end
end
...
assign boxColorB_val_read = boxColorB_val_read_local;

assign boxColorG_val_read = boxColorG_val_read_local;

assign boxColorR_val_read = boxColorR_val_read_local;

assign boxSize_val_read = boxSize_val_read_local;
...
assign colorFormat_val17_c_write = colorFormat_val17_c_write_local;

assign colorFormat_val_read = colorFormat_val_read_local;

assign conv2_i_i_i129_fu_284_p3 = ((cmp31_i_fu_278_p2[0:0] == 1'b1) ? 8'd240 : 8'd128);

assign crossHairX_val_read = crossHairX_val_read_local;

assign crossHairY_val_read = crossHairY_val_read_local;

assign empty_88_fu_267_p1 = height_val_dout[11:0];

assign empty_89_fu_304_p1 = maskId_val_dout[0:0];

assign empty_fu_262_p1 = width_val_dout[12:0];
...
assign height_val4_c_din = empty_88_fu_267_p1;
...
assign maskId_val_read = maskId_val_read_local;
...
assign width_val7_c_din = empty_fu_262_p1;
...
always @ (posedge ap_clk) begin
    conv2_i_i_i129_reg_500[3:0] <= 4'b0000;
    conv2_i_i_i129_reg_500[7] <= 1'b1;
