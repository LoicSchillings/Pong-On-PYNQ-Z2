...
attribute shreg_extract : string;
    ...
    signal conv2_i_i_i129_fu_284_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal conv2_i_i_i129_reg_500 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal boxColorB_val_read_local : STD_LOGIC;
    signal boxColorG_val_read_local : STD_LOGIC;
    signal boxColorR_val_read_local : STD_LOGIC;
    signal boxSize_val_read_local : STD_LOGIC;
    signal crossHairY_val_read_local : STD_LOGIC;
    signal crossHairX_val_read_local : STD_LOGIC;
    signal colorFormat_val_read_local : STD_LOGIC;
    signal colorFormat_val17_c_write_local : STD_LOGIC;
    signal motionSpeed_val_read_local : STD_LOGIC;
    signal maskId_val_read_local : STD_LOGIC;
    signal patternId_val_read_local : STD_LOGIC;
    signal width_val_read_local : STD_LOGIC;
    signal empty_fu_262_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal width_val7_c_write_local : STD_LOGIC;
    signal height_val_read_local : STD_LOGIC;
    signal empty_88_fu_267_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    port map (
        ...
        conv2_i_i_i129 => conv2_i_i_i129_reg_500,
        ...
        y => y_1_reg_540,
        motionSpeed => motionSpeed_val_read_reg_475,
        vMax => vMax_reg_510,
        hMax => hMax_reg_505,
        zext_ln1889 => shl_i_reg_535,
        icmp => icmp_reg_530,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                ...
                colorFormat_val_read_reg_470 <= colorFormat_val_dout;
                    conv2_i_i_i129_reg_500(6 downto 4) <= conv2_i_i_i129_fu_284_p3(6 downto 4);
    ...
    conv2_i_i_i129_reg_500(3 downto 0) <= "0000";
    conv2_i_i_i129_reg_500(7) <= '1';
    shl_i_reg_535(0) <= '0';
    ...
    boxColorB_val_read <= boxColorB_val_read_local;

    boxColorB_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            boxColorB_val_read_local <= ap_const_logic_1;
        else 
            boxColorB_val_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    boxColorG_val_read <= boxColorG_val_read_local;

    boxColorG_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            boxColorG_val_read_local <= ap_const_logic_1;
        else 
            boxColorG_val_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    boxColorR_val_read <= boxColorR_val_read_local;

    boxColorR_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            boxColorR_val_read_local <= ap_const_logic_1;
        else 
            boxColorR_val_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    boxSize_val_read <= boxSize_val_read_local;

    boxSize_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            boxSize_val_read_local <= ap_const_logic_1;
        else 
            boxSize_val_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    colorFormat_val17_c_write <= colorFormat_val17_c_write_local;

    colorFormat_val17_c_write_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            colorFormat_val17_c_write_local <= ap_const_logic_1;
        else 
            colorFormat_val17_c_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    crossHairX_val_read <= crossHairX_val_read_local;

    crossHairX_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            crossHairX_val_read_local <= ap_const_logic_1;
        else 
            crossHairX_val_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    crossHairY_val_read <= crossHairY_val_read_local;

    crossHairY_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            crossHairY_val_read_local <= ap_const_logic_1;
        else 
            crossHairY_val_read_local <= ap_const_logic_0;
        end if; 
    end process;

    empty_88_fu_267_p1 <= height_val_dout(12 - 1 downto 0);
    empty_89_fu_304_p1 <= maskId_val_dout(1 - 1 downto 0);
    empty_fu_262_p1 <= width_val_dout(13 - 1 downto 0);
    ...
    height_val4_c_din <= empty_88_fu_267_p1;
    ...
    maskId_val_read <= maskId_val_read_local;

    maskId_val_read_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            maskId_val_read_local <= ap_const_logic_1;
        else 
            maskId_val_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    width_val7_c_din <= empty_fu_262_p1;
